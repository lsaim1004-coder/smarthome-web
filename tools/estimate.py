...
PACKAGES: list[Package] = [
    ...
    Package("BASIC", "34평 기본 자동화", 1_190_000, 1_500_000, 2_500_000, "24~34평 기본 구축 150~250만(참고 조사) / 미소 30평대 200~400만 하단",
            bom={"hub_station": 1, "motion": 3, "door": 3, "plug": 3, "switch_2gang": 5, "temp": 2, "leak": 1},
            install_hours=6, commission_hours=5, integrations=["가전 2종"], automations=3),
    Package("STANDARD", "34평 표준 (주력)", 1_990_000, 2_000_000, 3_500_000, "20평대 표준 200~350만 / 30평대 200~400만",
            bom={"hub_station": 1, "motion": 4, "door": 3, "plug": 3, "switch_2gang": 6, "temp": 2, "leak": 2},
            install_hours=8, commission_hours=7, integrations=["도어락", "에어컨", "로봇청소기"], automations=4, include_design_in_comp=True),
    Package("PREMIUM", "34평 풀 스마트홈 + 세대 HA", 3_390_000, 3_500_000, 7_000_000, "30~40평 아파트 350~700만 / 강남 시작·표준형 300~1,200만",
            ...
            install_hours=16, commission_hours=12, integrations=["도어락", "에어컨", "로봇청소기", "TV·냉장고·세탁기"], automations=6, misc=50_000, include_design_in_comp=True),
    Package("FULL HOME", "전실 조명·커튼·도어락 신규 + HA", 5_390_000, 7_000_000, 15_000_000, "프리미엄 700~1,500만 / 강남 확장·프리미엄형 1,000~2,000만",
            ...
            install_hours=24, commission_hours=16, integrations=["도어락", "에어컨", "로봇청소기", "TV·냉장고·세탁기", "음성(빅스비·Google)"], automations=8, misc=80_000, include_design_in_comp=True),
]
